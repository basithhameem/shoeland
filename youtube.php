          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='addnewyoutube_form.php'">Add New Video</button>
                </div>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='youtube_update.php'">View</button>
                </div>
              </div>
            </div>
          </div>
