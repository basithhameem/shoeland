        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form enctype="multipart/form-data" method="post" action="notification_upload.php">
                <div class="form-group">
                  <label for="Notification">Notification</label>
                  <input type="text" class="form-control" id="element_1" placeholder="Write Here" maxlength="255" value="" name="element_1" required/>
                </div>
                <div class="form-group">
