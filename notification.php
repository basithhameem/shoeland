          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='addnewnotification_form.php'">Add New Notification</button>
                </div>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='notification_update.php'">View</button>
                </div>
              </div>
            </div>
          </div>
