        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $link=$_POST['element_1'];
              $comment=$_POST['element_2'];
              $filetmp = $_FILES["element_3"]["tmp_name"];
              //Set id to zero
              $last_id=0;
              // Selecting the last id from table
              $query="SELECT id FROM Social ORDER BY id DESC LIMIT 1;";
              ...
              $last_id=$last_id+1;
              //Renaming...
              $filename="social".$last_id;
              $filepath = "photo/".$filename;
              move_uploaded_file($filetmp,$filepath);
              $query="INSERT INTO Social VALUES (DEFAULT,'$filepath','$comment','$link');";
              $result=mysqli_query($con,$query);
              if ($result)
                {
