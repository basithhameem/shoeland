        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $home_name=$_POST['element_1'];
              $filetmp = $_FILES["element_2"]["tmp_name"];
                $last_hid=0;
              //select the last id from table
              $query="SELECT hid FROM home ORDER BY hid DESC LIMIT 1;";
              ...
              $last_hid=$last_hid+1;
              //renaming
              $filename="home".$last_hid;

              $filepath = "photo/".$filename;
              move_uploaded_file($filetmp,$filepath);
              $query="INSERT INTO home VALUES (DEFAULT,'$home_name','$filename','$filepath');";
              $result=mysqli_query($con,$query);
              if ($result)
                {
