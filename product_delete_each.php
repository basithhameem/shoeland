        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $query1="SELECT * from SHOELANDPRODUCTS;";
              $result1=mysqli_query($con,$query1);
              $row_count=mysqli_num_rows($result1);
                if($row_count==1)
                {
                  $query1="ALTER TABLE `SHOELANDPRODUCTS` AUTO_INCREMENT = 1;";
                  $result1=mysqli_query($con,$query1);
                  if($result1)
                  echo "Table set to default \n";
                }
              $query="DELETE FROM SHOELANDPRODUCTS WHERE pid=$id;";
