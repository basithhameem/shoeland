        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $bid=$_POST['brand_id'];
              $query="SELECT * FROM SHOELANDBRAND WHERE id=$bid;";
              ...
              while($row = mysqli_fetch_array($result))
                ...
                ?>
                <form enctype="multipart/form-data" method="post" action="brand_update_upload.php">
                  <div class="form-group">
                    <label for="Brand">Brand Name</label>
                    <input type="text" class="form-control" id="element_1" placeholder="Name" maxlength="255" value="<?php echo $bname ?>" name="element_1" required/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Upload Image</label>
                    <input type="file" id="element_2" name="element_2" required>
                    <p class="help-block">Upload proper image of brand </p>
                  </div>
                  <div>
                    <input type="hidden" name="element_3" value= <?php echo $bid ?> >
                  </div>
              ...
              <br>
              <div>
              <form enctype="multipart/form-data" method="post" action="brand_delete_each.php">
                <div>
                  <input type="hidden" name="tempid_delete" value= <?php echo $bid ?> >
                </div>
                <div>
                  <input type="hidden" name="bpath" value= <?php echo $path ?> >
                </div>
