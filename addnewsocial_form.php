        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Enter Facebook post details</h3>
            </div>
            <div class="panel-body">

              <form enctype="multipart/form-data" method="post" action="social_upload.php">
                <div class="form-group">
                  <label for="Social">Facebook Post Link</label>
                  <input type="text" class="form-control" id="element_1" placeholder="Paste link here" value="" name="element_1" required/>
                </div>
                <div class="form-group">
                  <label for="comment">Comment</label>
                  <input type="text" class="form-control" id="element_2" placeholder="Write some comment" maxlength="255" value="" name="element_2" required/>
                </div>
                <div class="form-group">
