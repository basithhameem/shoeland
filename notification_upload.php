        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Upload Status</h3>
            </div>
            <div class="panel-body">
              <?php
              require_once("dbConnect.php");
              $notification=$_POST['element_1'];
              $filetmp = $_FILES["element_2"]["tmp_name"];
              // Selecting the last id from table
              $last_nid=0;
              $query="SELECT nid FROM Notification ORDER BY nid DESC LIMIT 1;";
              ...
              $last_nid=$last_nid+1;
              //Renaming...
              $filename="notification".$last_nid;
              $filepath = "photo/".$filename;
              move_uploaded_file($filetmp,$filepath);
              $query="INSERT INTO Notification VALUES (DEFAULT,'$filepath','$notification');";
              $result=mysqli_query($con,$query);
              if ($result)
                {
