        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $sid=$_POST['tempid_delete'];
              $path=$_POST['filepath'];
              $query1="SELECT * from Social;";
              $result1=mysqli_query($con,$query1);
              $row_count=mysqli_num_rows($result1);
                if($row_count==1)
                {
                  $query1="ALTER TABLE `Social` AUTO_INCREMENT = 1;";
                  $result1=mysqli_query($con,$query1);
                }
              $query="DELETE FROM Social WHERE id=$sid;";
              ...
              if (!unlink($file))
                ...
                {
                echo ("Deleting Image from server...\n ");
                echo "<br>";
                }
