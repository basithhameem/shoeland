        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              echo "Notifications Database is empty!!! Go to Notificatios tab and add a new notification";
              while($row = mysqli_fetch_array($result))
                {
                echo "<tr>";
                echo "<td>" . $row['nid'] . "</td>";
                echo "<td>" . $row['notification'] . "</td>";
                echo "<td> <form action='notification_update_each.php' method='POST'><input type='hidden' name='tempid' value='".$row["nid"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Update/Delete' /></form></td></tr>";
                }
              echo "</table>";
