...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You may update/delete category details</li>
          </ol>
      </div>
    </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Update Category Detail</h3>
            </div>
            <div class="panel-body">
              ...
              while($row = mysqli_fetch_array($result))
                ...
                $pimgname=$row['imagename'];
                $ppath=$row['imagelink'];
                }
                ?>
              <form enctype="multipart/form-data" method="post" action="home_update_upload.php">
                <div class="form-group">
                  <label for="Home_Category">Update Home Category Name</label>
                  <input type="text" class="form-control" id="element_1" placeholder="Name" maxlength="255" value="<?php echo $pname ?>" name="element_1" required/>
                </div>
                <div class="form-group">
                ...
                <div>
                  <input type="hidden" name="element_3" value= <?php echo $homeid ?> >
                </div>
              ...
              <br>
              <div>
              <form enctype="multipart/form-data" method="post" action="home_delete_each.php">
                <div>
                  <input type="hidden" name="tempid_delete" value= <?php echo $homeid ?> >
                </div>
                <div>
                  <input type="hidden" name="filepath" value= <?php echo $ppath ?> >
                </div>
