        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $ylink=$_POST['element_1'];
              $ylink=trim($ylink,"https://www.youtube.com/watch?v=");
              $ycomment=$_POST['element_2'];
              $yid=$_POST['element_3'];
              $query="UPDATE Youtube SET Youtubeid='$ylink',comment='$ycomment' WHERE id=$yid;";
              $result=mysqli_query($con,$query);
              if ($result)
                {
              echo "Youtube Video Updated Successfully";
              header( "refresh:4;url=youtube.php" );
                }
              else {
