        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $result = mysqli_query($con,"SELECT * FROM SHOELANDBRAND");
              ...
              echo "Brands Database is empty!!! Go to Brands tab and add a new brand";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td> <form action='brand_update_each.php' method='POST'><input type='hidden' name='brand_id' value='".$row["id"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Update/Delete' /></form></td></tr>";
                }
              echo "</table>";
