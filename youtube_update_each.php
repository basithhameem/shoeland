...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You may add or update youtube videos to application</li>
          </ol>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="youtube.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-facetime-video" aria-hidden="true"></span> Youtube Link</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $yid=$_POST['tempid'];
              $query="SELECT * FROM Youtube WHERE id=$yid;";
              $result=mysqli_query($con,$query);
              while($row = mysqli_fetch_array($result))
                {
                $yid=$row['id'];
                $Youtubeid=$row['Youtubeid'];
                $ycomment=$row['comment'];
                }
                $Youtubeid= "https://www.youtube.com/watch?v=".$Youtubeid;
                ?>
                <form enctype="multipart/form-data" method="post" action="youtube_update_upload.php">
                  <div class="form-group">
                    <label for="Youtube">Youtube Video Link</label>
                    <input type="text" class="form-control" id="element_1" placeholder="Paste link here" maxlength="255" value="<?php echo $Youtubeid ?>" name="element_1" required/>
                  </div>
                  <div class="form-group">
                    <label for="comment">Comment</label>
                    <input type="text" class="form-control" id="element_2" placeholder="Write some comment" maxlength="255" value="<?php echo $ycomment ?>" name="element_2" required/>
                  </div>
                  <div>
                    <input type="hidden" name="element_3" value= <?php echo $yid ?> >
                  </div>
                  <button type="submit" class="btn btn-default main-color-bg btn-lg">Update</button>
                </form>
              <br>
              <br>
              Delete The selected youtube video
              <br>
              <div>
              <form enctype="multipart/form-data" method="post" action="youtube_delete_each.php">
                <div>
                  <input type="hidden" name="tempid_delete" value= <?php echo $yid ?> >
                </div>
