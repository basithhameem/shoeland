        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="help_brands.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span> To Update Brands</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">How to Update Brands</h3>
            </div>
            <div class="panel-body">
              <ol start="1">
                <li>Navigate to Dashboard.</li>
                <li>Click on "Brands" on the menu given.</li>
                <li>Click the button "Add new Brand" to add new brand or "View" to update/delete existing.</li>
