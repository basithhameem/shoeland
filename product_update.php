        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $result = mysqli_query($con,"SELECT * FROM SHOELANDPRODUCTS");
              ...
              echo "Product Database is empty!!! Go to Products tab and add a new product";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td> <form action='product_update_each.php' method='POST'><input type='hidden' name='productid' value='".$row["pid"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Update/Delete' /></form></td></tr>";
