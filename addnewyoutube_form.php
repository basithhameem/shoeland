...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">New Video Details</li>
          </ol>
      </div>
    </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Enter Video Detail</h3>
            </div>
            <div class="panel-body">

                <form enctype="multipart/form-data" method="post" action="youtube_upload.php">
                  <div class="form-group">
                    <label for="Youtube">Youtube Video Link</label>
                    <input type="text" class="form-control" id="element_1" placeholder="Paste link here" maxlength="255" value="" name="element_1" required/>
                  </div>
                  <div class="form-group">
