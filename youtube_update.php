        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $result = mysqli_query($con,"SELECT * FROM Youtube");
              ...
              echo "Youtube link Database is empty!!! Go to Youtube Link tab and add a new video";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td> <form action='youtube_update_each.php' method='POST'><input type='hidden' name='tempid' value='".$row["id"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Update/Delete' /></form></td></tr>";
                }
              echo "</table>";
