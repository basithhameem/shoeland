          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='addnewbrand_form.php'">Add New Brand</button>
                </div>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='brand_update.php'">View</button>
                </div>
              </div>
            </div>
          </div>
