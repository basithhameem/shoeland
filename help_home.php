        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="help_home.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span> To Update Home</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">How to Update Home Category</h3>
            </div>
            <div class="panel-body">
              <ol start="1">
                <li>Navigate to Dashboard.</li>
                <li>Click on "Home" on the menu given.</li>
                <li>Click the button "Add new Category" to add new category or "View" to update/delete existing.</li>
