        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="help_youtube.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-facetime-video" aria-hidden="true"></span> To Update Youtube Link</a>
              <a href="help_notification.php" class="list-group-item"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> To Update Notifications</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">How to Update Youtube videos in app</h3>
            </div>
            <div class="panel-body">
              <ol start="1">
                <li>Navigate to Dashboard.</li>
                <li>Click on "Youtube Link" on the menu given.</li>
                <li>Click the button "Add new Video" to add new video or "View" to update/delete existing.</li>
                <li>Fill the appropriate form given, give proper youtube link and click Submit.</li>
                <li>You are done !!!</li>
              </ol>
            </div>
          </div>
