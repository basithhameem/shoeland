        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              echo "Social Feed Database is empty!!! Go to Social Feeds tab and add a new post";
              while($row = mysqli_fetch_array($result))
                ...
                //echo "<td>" . $row['link'] . "</td>";
                echo "<td> <form action='social_update_each.php' method='POST'><input type='hidden' name='tempid' value='".$row["id"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Update/Delete' /></form></td></tr>";
                }
              echo "</table>";
