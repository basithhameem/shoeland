        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $query="SELECT id FROM SHOELANDBRAND ORDER BY id DESC LIMIT 1;";
              ...
              $last_id=$last_id+1;
              //Renaming...
              $filename="brand".$last_id;

              $filepath = "photo/".$filename;
              move_uploaded_file($filetmp,$filepath);
              $query="INSERT INTO SHOELANDBRAND VALUES (DEFAULT,'$brand_name','$filename','$filepath');";
              $result=mysqli_query($con,$query);
              if ($result)
                {
              echo "Brand Added Successfully";
              header( "refresh:3;url=brands.php" );
                }
              else {
