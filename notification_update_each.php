...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You may add or update notification to application</li>
          </ol>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="notification.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Notifications</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Application Notification</h3>
            </div>
            <div class="panel-body">
              ...
              $nid=$_POST['tempid'];
              $query="SELECT * FROM Notification WHERE nid=$nid;";
              ...
              while($row = mysqli_fetch_array($result))
                ...
                ?>
                <form enctype="multipart/form-data" method="post" action="notification_update_upload.php">
                  <div class="form-group">
                    <label for="Notification">Notification</label>
                    <input type="text" class="form-control" id="element_1" placeholder="Write Here" maxlength="255" value="<?php echo $notification ?>" name="element_1" required/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Upload Image</label>
                    <input type="file" id="element_2" name="element_2" required>
                    <p class="help-block">Upload proper image of notification </p>
                  </div>
                  <div>
                      <input type="hidden" name="element_3" value= <?php echo $nid ?> >
                  </div>
              ...
              <br>
              <div>
              <form enctype="multipart/form-data" method="post" action="notification_delete_each.php">
                <div>
                  <input type="hidden" name="tempid_delete" value= <?php echo $nid ?> >
                </div>
                <div>
                  <input type="hidden" name="npath" value= <?php echo $npath ?> >
                </div>
