...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You may view your registered user details</li>
          </ol>
      </div>
    </section>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.location.href='view_user.php'">View Details</button>
                </div>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-default main-color-bg" onclick="window.open('pdf/topdf.php')">Open as pdf</button>
                </div>
              </div>
            </div>
          </div>
