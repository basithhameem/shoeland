        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="help_social.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span> To Update Social Feeds</a>
            </div>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">How to Update Facebook Page feeds in app</h3>
            </div>
            <div class="panel-body">
              <ol start="1">
                <li>Navigate to Dashboard.</li>
                <li>Click on "Social Feeds" on the menu given.</li>
                <li>Click the button "Add new Post" to add new feed or "View" to update/delete existing.</li>
