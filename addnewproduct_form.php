...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">New Product Details</li>
          </ol>
      </div>
    </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Enter Product Detail</h3>
            </div>
            <div class="panel-body">

                <form enctype="multipart/form-data" method="post" action="product_upload.php">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="element_3" placeholder="Price" maxlength="255" value="" name="element_3"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Size</label>
                    <input type="text" class="form-control" id="element_4" placeholder="Size" name="element_4">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Colour</label>
                    <input class="form-control" type="color" id="element_5" name="element_5" value="#000000" required>
                  </div>
                  <div class="form-group">
