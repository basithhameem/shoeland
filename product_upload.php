        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $query="SELECT pid FROM SHOELANDPRODUCTS ORDER BY pid DESC LIMIT 1;";
              ...
              $last_pid=$last_pid+1;
              //Renaming...
              $filename="product".$last_pid;
              $filepath = "photo/".$filename;
              //Uploading...
              move_uploaded_file($filetmp,$filepath);
              $query="INSERT INTO SHOELANDPRODUCTS VALUES (DEFAULT,'$product_name','$price','$classification', '$size', '$colour','$filepath','$filename');";
              $result=mysqli_query($con,$query);
              if ($result)
              {
